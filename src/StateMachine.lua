--[[
	A word of thanks. This state machine provided by Colton Ogdon in the second cs50g lecture. 
	I was going to use the state macihine found in HUMP but at a mere 20ish lines of code,
	Colton's is MUCH simpler and easier to use. It was instramental to me in learning what a state machine
	is and how they function and is the backbone of all the states I wrote for this game.
	I've left his comments intact because OBVIOUSLY and if I ever meet him in person there~s a free beer with his name on it.
]]--
